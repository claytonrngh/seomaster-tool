...
INSERT INTO "new_User" ("createdAt", "credits", "email", "emailVerified", "id", "name", "password") SELECT "createdAt", "credits", "email", "emailVerified", "id", "name", "password" FROM "User";
DROP TABLE "User";
